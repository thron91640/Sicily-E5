...
class __TwigTemplate_0a2d9ea688d9661c0671dd6d816a5078 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"example-wrapper\">
    ";
        // line 12
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["inscription"]) || array_key_exists("inscription", $context) ? $context["inscription"] : (function () { throw new RuntimeError('Variable "inscription" does not exist.', 12, $this->source); })()), 'form');
        echo "
</div>
";
...
{% endblock %}
", "inscription/index.html.twig", "/var/www/html/projetSicily/templates/inscription/index.html.twig");
    }
}
