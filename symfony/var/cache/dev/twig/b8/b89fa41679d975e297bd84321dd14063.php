...
class __TwigTemplate_93c2847ddefd689d547910a9f7298679 extends Template
{
    private $source;
    private $macros = [];
...
<head>
  ...
  <nav class=\"navbar navbar-dark bg-dark\">
  <span class=\"navbar-brand mb-0 h1\" href={{ path ('accueil')}}>Navbar</span>
</nav>
<button type=\"button\" class=\"btn btn-primary\" href={{ path ('connexion')}}>Primary</button>", "header/header.html.twig", "/var/www/html/projetSicily/templates/header/header.html.twig");
    }
}
