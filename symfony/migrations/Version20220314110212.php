 ...
 */
final class Version20220314110212 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contenir_bateau (contenir_id INT NOT NULL, bateau_id INT NOT NULL, INDEX IDX_BFA35CCB1982B715 (contenir_id), INDEX IDX_BFA35CCBA9706509 (bateau_id), PRIMARY KEY(contenir_id, bateau_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE contenir_categorie (contenir_id INT NOT NULL, categorie_id INT NOT NULL, INDEX IDX_4267EF191982B715 (contenir_id), INDEX IDX_4267EF19BCF5E72D (categorie_id), PRIMARY KEY(contenir_id, categorie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
